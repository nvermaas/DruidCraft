  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView.setImageResource(this.mImageIds[paramInt].intValue());
    paramView.setLayoutParams(new Gallery.LayoutParams(262, 415));
    paramView.setScaleType(ImageView.ScaleType.FIT_XY);
    paramView.setBackgroundResource(this.mGalleryItemBackground);
    return paramView;
  }
}


/* Location:              R:\source\java_android\DruidCraft\classes-dex2jar.jar!\nl\uilennest\druid\tarot\druidcraft\ImageAdapterGallery.class
